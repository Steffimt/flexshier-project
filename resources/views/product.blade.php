        ...
        @if(isset($products))
            @foreach($products as $product)
                <div class="product-item">
                    ...
                    <h5 class="product-image">{{ $product->image_name }}</h5>
                    <span class="regular-price">{{ $product->sale_price }}</span>
                    <span class="regular-price">{{ $product->price }}</span>
                    <!-- Call addToCart method with the product ID -->
                    <button class="btn-pay" onclick="addToCart({{ $product->id }}, 1)">Add to Cart</button>
                </div>
            @endforeach
        @endif
    </div>

    <!-- Include your JavaScript code below or in a separate file -->
    <script>
    ...
    <head>
        ...
        <script>
            ...
            function addToCart(productId, quantity) {
                ...
                .then(function(response) {
                    // Retrieve the index of the products from the response
                    var productIndex = response.data.index;
                    // Display the product index
